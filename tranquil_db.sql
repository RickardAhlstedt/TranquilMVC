...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2018 at 09:40 PM
...
INSERT INTO `entnavigation` (`navigationId`, `navigationGroup`, `navigationParentId`, `navigationName`, `navigationHref`, `navigationBehavior`, `navigationPrefixContent`) VALUES
(1, 'guest', 0, 'Home', '/', '_self', ''),
(2, 'guest', 1, 'Sub', '/', '_self', ''),
(3, 'admin', 0, 'Dashboard', '/admin', '_self', '<i class="fas fa-tachometer-alt"></i>'),
(4, 'admin', 0, 'Pages', '/admin/infoContent', '_self', '<i class="far fa-file-alt"></i>');
...
(1, 'developer', '7e7aad44abe3c029bd3a7543520605e1', 'admin', '', '2018-03-05 21:35:25', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
